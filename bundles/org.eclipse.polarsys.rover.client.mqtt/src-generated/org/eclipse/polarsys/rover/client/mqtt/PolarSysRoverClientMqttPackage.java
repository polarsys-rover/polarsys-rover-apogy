...
public interface PolarSysRoverClientMqttPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int POLAR_SYS_ROVER_CLIENT_MQTT_FEATURE_COUNT = PolarSysRoverClientPackage.POLAR_SYS_ROVER_CLIENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int POLAR_SYS_ROVER_CLIENT_MQTT_OPERATION_COUNT = PolarSysRoverClientPackage.POLAR_SYS_ROVER_CLIENT_OPERATION_COUNT + 0;
