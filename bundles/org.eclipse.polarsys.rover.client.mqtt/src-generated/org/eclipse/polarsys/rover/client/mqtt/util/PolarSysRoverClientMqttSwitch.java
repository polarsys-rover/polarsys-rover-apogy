 ...
 */
package org.eclipse.polarsys.rover.client.mqtt.util;
 ...
 * @generated
 */
public class PolarSysRoverClientMqttSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static PolarSysRoverClientMqttPackage modelPackage;
	 ...
	 * @generated
	 */
	public PolarSysRoverClientMqttSwitch() {
		if (modelPackage == null) {
			modelPackage = PolarSysRoverClientMqttPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PolarSysRoverClientMqttPackage.POLAR_SYS_ROVER_CLIENT_MQTT: {
				...
				if (result == null) result = casePolarSysRoverClient(polarSysRoverClientMqtt);
