 ...
 */
package org.eclipse.polarsys.rover.client.ros.util;
 ...
 * @generated
 */
public class PolarSysRoverClientRosSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static PolarSysRoverClientRosPackage modelPackage;
	 ...
	 * @generated
	 */
	public PolarSysRoverClientRosSwitch() {
		if (modelPackage == null) {
			modelPackage = PolarSysRoverClientRosPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PolarSysRoverClientRosPackage.POLAR_SYS_ROVER_CLIENT_ROS: {
				...
				if (result == null) result = casePolarSysRoverClient(polarSysRoverClientRos);
